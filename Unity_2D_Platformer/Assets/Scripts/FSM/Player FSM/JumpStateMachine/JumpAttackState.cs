...
public class JumpAttackState : IState, IGravityModifier
{
    private PlayerJumpStateMachine sm;
    public JumpAttackState(PlayerJumpStateMachine playerJumpStateMachine)
    {
    ...
    private void Jump()
    {
        ...
        float force = sm.owner.movementType.bounceForce;
